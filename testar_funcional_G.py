#!/usr/bin/env python3
"""
Simulador funcional de Máquina de Turing para linguagem {wwR | w ∈ {a,b}*}
"""

import json
import xml.etree.ElementTree as ET

class FunctionalTuringMachine:
    ...
    def simulate(self, input_string, max_steps=1000):
        ...
        # Inicializar fita com símbolos vazios nas bordas
        tape = ['_'] + list(input_string) + ['_']
        head_position = 1  # Começar na primeira posição da entrada
...
def test_functional_cases():
    """Testa casos funcionais"""
    
    machine = FunctionalTuringMachine('atividade turing/G linguagem_wwr_w_em_ab_estrela_FUNCIONAL.jff')
    ...
    print("="*70)
    print("TESTANDO MÁQUINA FUNCIONAL")
    print("="*70)
