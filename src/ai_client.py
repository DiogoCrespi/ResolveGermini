...
def get_ai_functions():
    ...
    if AI_MODEL == "gpt":
        try:
            ...
            return extract_with_ai, segment_text_into_questions, validate_grammars, merge_blocks
...
try:
    extract_with_ai, segment_text_into_questions, validate_grammars, merge_blocks = get_ai_functions()
