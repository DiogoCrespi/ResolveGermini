#!/usr/bin/env python3
"""
Simulador que trata corretamente símbolos vazios para linguagem {wwR | w ∈ {a,b}*}
"""

import json
import xml.etree.ElementTree as ET

class CorrectTuringMachine:
...
def test_correct_cases():
    """Testa casos corretos"""
    
    machine = CorrectTuringMachine('atividade turing/G linguagem_wwr_w_em_ab_estrela_NOVA.jff')
    ...
    print("="*70)
    print("TESTANDO MÁQUINA CORRETA")
    print("="*70)
